                      ...
                      {section.items ? section.items.map(item => (
                        <button
                          ...
                          style={{
                            ...
                            border: "none",
                            borderLeft: activeTab === item.id ? '3px solid var(--fs-accent)' : '3px solid transparent',
                            cursor: "pointer",
                            fontSize: 14,
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: "none",
                            borderLeft: activeTab === section.id ? '3px solid var(--fs-accent)' : '3px solid transparent',
                            cursor: "pointer",
                            fontSize: 14,
