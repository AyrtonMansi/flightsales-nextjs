    ...
    <div className="fs-login-shell">
      <aside className="fs-login-brand">
        <div className="fs-login-brand-inner">
          {/* Same Bootstrap `airplane-fill` mark as the nav so the brand
              panel reads as the same product, not a placeholder. */}
          <svg className="fs-login-brand-mark" width="36" height="36" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
          ...
          <ul className="fs-login-brand-points">
            <li>Free listings for private sellers</li>
            <li>Dealers verified against the Australian Business Register</li>
            <li>No commission on the sale</li>
          </ul>
        </div>
      </aside>
