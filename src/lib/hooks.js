...
// ── Affiliate partners ──────────────────────────────────────────
//
// Public-read of active affiliates (used by listing detail CTAs and
// the /partners page). Admin-side gets the full row set including
// pending/paused/terminated for management.
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // letting Postgres handle every combo would mean ten queries.
